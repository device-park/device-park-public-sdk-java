...
import io.testinium.devicepark.model.applications.ApplicationFilterRequest;
...
public final class ApplicationApi {
    ...
    public PageDto<Application> list(ApplicationPaginationRequest request) {
        ...
        List<ApplicationFilterRequest> filters = req.getFilters();
        ...
        if (filters != null) {
            int filterIndex = 0;
            for (ApplicationFilterRequest filter : filters) {
                if (filter == null) {
                    continue;
                }
